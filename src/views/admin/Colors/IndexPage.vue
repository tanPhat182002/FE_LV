<!-- views/admin/Colors/IndexPage.vue -->
<template>
    ...
    >
      <v-card>
        ...
        <v-card-text class="pa-4 py-2">
          ...
          <strong>"{{ selectedColor?.name }}"</strong>?<br>
...
const handleDelete = async () => {
  ...
  try {
    ...
    await store.dispatch('colors/deleteColor', selectedColor.value.id)
...
onMounted(async () => {
  try {
    await store.dispatch('colors/fetchColors')
  } catch (error) {
